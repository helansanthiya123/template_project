  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="{{ route('showfruit') }}">
            <i class="bi bi-circle"></i><span>Add Fruit</span>
          </a>
        </li>
        <li>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="{{ route('managefruit') }}">
        <i class="bi bi-person"></i>
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ url('addfruit') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="rate" class="form-control" pattern="[0-9]{1,5}" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-3 col-form-label">Fruit Name</label>
                  <div class="col-sm-9">
                    <input type="text" name="fruit_name" class="form-control" pattern="[A-Za-z]{1,32}" required>
                  </div>
                </div>
                <div class="row mb-3">
          ...
          <div class="col-lg-6">
            ...
            @if (Session::has('add_fruit_success'))
            <div class="alert alert-primary alert-dismissible">
              <button type="button" class="btn-close alert-del" data-bs-dismiss="alert"></button>
              <strong>Success!</strong> {{ Session::get('add_fruit_success') }}.
            </div>
            @endif
          </div>
