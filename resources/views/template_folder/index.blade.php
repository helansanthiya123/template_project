				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img src="{{ asset('images/'.$product->image_name) }}" alt="" height="250" width="100"></a>
						</div>
						<h3>{{ $product->fruit_name }}</h3>
						<p class="product-price"><span>Per Kg</span> {{ $product->rate }}$ </p>

						<a href="#" class="cart-btn add_cart" id="{{ $product->id }}"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
