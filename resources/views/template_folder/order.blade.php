						...
						<table class="cart-table" id="cart_table_rows">
							<thead class="cart-table-head">
								<tr class="table-head-row">
									<th class="product-remove">Tracking Number</th>
									<th class="product-image">Total Price</th>
							...
							@foreach ($orders as $order)
                                <tr class="table-body-row" >
                                    <td class="product-remove">{{ $order->tracking_no }}</td>
                                    <td class="product-image">{{ $order->subtotal }}</td>
									<td class="product-image">{{ $order->status=='0' ?'Pending':'Completed' }}</td>
